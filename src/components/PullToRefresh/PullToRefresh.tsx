...
export const PullToRefresh: React.FC<PullToRefreshProps> = ({ onRefresh, children }) => {
    ...
    const getScrollContainer = () => {
        return document.querySelector('.mobile-layout__content') as HTMLElement | null;
    };
    ...
    const handleTouchStart = (e: React.TouchEvent) => {
        ...
        if (target?.closest('button, a, input, textarea, select, [role="button"], [data-no-pull-refresh="true"]')) {
            return;
        }
