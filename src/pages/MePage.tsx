...
const UserHeader = () => {
    ...
    return (
        <div 
            onClick={() => navigate(ROUTE_PATHS.profileInfo)}
            {...touchProps}
            style={{ 
        ...
        >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <div 
                    onClick={(e) => { e.stopPropagation(); navigate(ROUTE_PATHS.myQRCode); }}
    ...
    <div style={{ background: 'var(--bg-body)', minHeight: '100%', paddingBottom: '20px' }}>
      ...
      <CellGroup>
        <Cell 
            ...
            isLink
            onClick={() => navigate(ROUTE_PATHS.wallet)}
        />
      </CellGroup>
      ...
      <CellGroup>
        <Cell 
            ...
            isLink
            onClick={() => navigate(ROUTE_PATHS.favorites)}
        />
        <Cell 
            title="我的作品" 
            ...
            isLink
            onClick={() => navigate(ROUTE_PATHS.creation)}
        />
        <Cell 
            title="我的智能体" 
        ...
        <Cell 
            ...
            isLink
            onClick={() => navigate(ROUTE_PATHS.general, { title: '卡包' })}
        />
      </CellGroup>
