    ...
    <article className="moments-page__item">
      ...
      >
        <img
          ...
          alt={item.author}
          className="moments-page__avatar"
        />
      </button>
      ...
      <div className="moments-page__item-main">
        ...
        <div className="moments-page__meta">
          <div className="moments-page__meta-left">
            ...
            {item.hasLiked ? <span className="moments-page__liked">Liked {item.likes}</span> : null}
          </div>
...
export const MomentsPage: React.FC<MomentsPageProps> = ({ onBack, onProfileClick }) => {
  const { moments, isLoading, loadMoments, publishMoment, likeMoment } = useMoments();
  ...
  const handlePublish = async () => {
    const content = window.prompt('Share what is on your mind', 'Today is a productive day');
    ...
    <div className="moments-page">
      <div className="moments-page__nav-fixed">
        <Navbar
          ...
          rightElement={(
            <button
              type="button"
              className="moments-page__publish-btn"
      ...
      <div ref={scrollRef} className="moments-page__scroll" onScroll={handleScroll}>
        ...
        <div className="moments-page__list">
          ...
          {isLoading ? <div className="moments-page__status">Loading moments...</div> : null}
          {!isLoading && moments.length === 0 ? <div className="moments-page__status">No moments yet</div> : null}
          {!isLoading && !hasMore && moments.length > 0 ? <div className="moments-page__status">No more moments</div> : null}
        </div>
      </div>
