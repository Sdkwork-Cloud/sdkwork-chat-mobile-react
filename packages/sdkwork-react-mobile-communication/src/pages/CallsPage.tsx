...
export const CallsPage: React.FC<CallsPageProps> = ({ t, onCallClick }) => {
  ...
  return (
    <div className="h-full flex flex-col bg-gray-50 dark:bg-gray-900">
      <div className="flex items-center px-4 py-3 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <h1 className="text-lg font-semibold text-gray-900 dark:text-white">{tr('calls.title', 'Call History')}</h1>
      </div>
