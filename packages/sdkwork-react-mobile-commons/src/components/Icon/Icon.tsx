...
export type IconName =
  ...
  | 'user' | 'lock' | 'location' | 'shake'
  | 'sparkles' | 'spark' | 'briefcase' | 'palette' | 'book' | 'coffee'
  | 'home' | 'group' | 'addUser' | 'dumbbell' | 'gamepad' | 'smartphone' | 'shirt' | 'utensils';
...
const PATHS: Record<string, React.ReactElement> = {
  ...
  shop: <><path d="M7 9h10l-1 11H8L7 9z" /><path d="M9 9V7a3 3 0 0 1 6 0v2" /></>,
  ...
  location: <path d="M12 2c3.87 0 7 3.13 7 7 0 5.25-7 13-7 13S5 14.25 5 9c0-3.87 3.13-7 7-7zm0 4a3 3 0 1 0 0 6 3 3 0 0 0 0-6z" />,
  shake: <path d="M8 3h8a2 2 0 0 1 2 2v3h-2V6H8v12h8v-2h2v3a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2zm12.5 9.5H11m6-3 3.5 3-3.5 3" />,
  user: <><circle cx="12" cy="8" r="4" /><path d="M5 20c0-3.31 3.13-6 7-6s7 2.69 7 6" /></>,
  lock: <><rect x="5" y="11" width="14" height="10" rx="2" /><path d="M8 11V8a4 4 0 0 1 8 0v3" /></>,
  sparkles: <><path d="M12 3l1.8 3.7L18 8.5l-4.2 1.8L12 14l-1.8-3.7L6 8.5l4.2-1.8L12 3z" /><path d="M19 3l.7 1.5L21 5l-1.3.5L19 7l-.7-1.5L17 5l1.3-.5L19 3z" /><path d="M5 16l1 2 2 1-2 1-1 2-1-2-2-1 2-1 1-2z" /></>,
  spark: <path d="M12 3l2 4 4 2-4 2-2 4-2-4-4-2 4-2 2-4z" />,
  briefcase: <><rect x="3" y="7" width="18" height="13" rx="2" /><path d="M9 7V5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2" /><path d="M3 12h18" /></>,
  palette: <><path d="M12 3a9 9 0 0 0 0 18h1.2a2.3 2.3 0 0 0 0-4.6h-.7a1.8 1.8 0 0 1 0-3.6H15a6 6 0 0 0 0-12h-3z" /><circle cx="7.5" cy="9" r="1" /><circle cx="9.5" cy="6.8" r="1" /><circle cx="12.8" cy="6.2" r="1" /><circle cx="15.4" cy="8.4" r="1" /></>,
  book: <><path d="M4 5.5A2.5 2.5 0 0 1 6.5 3H20v17H6.5A2.5 2.5 0 0 0 4 22V5.5z" /><path d="M4 5h13" /></>,
  coffee: <><path d="M4 8h11a0 0 0 0 1 0 0v4a5 5 0 0 1-5 5H9a5 5 0 0 1-5-5V8z" /><path d="M15 9h2a2 2 0 1 1 0 4h-2" /><path d="M7 3v2M10 3v2M13 3v2" /></>,
  home: <><path d="M3 11.5 12 4l9 7.5" /><path d="M6 10.5V20h12v-9.5" /></>,
  group: <><circle cx="8" cy="9" r="3" /><circle cx="16" cy="9" r="3" /><path d="M2.5 20a5.5 5.5 0 0 1 11 0" /><path d="M10.5 20a5.5 5.5 0 0 1 11 0" /></>,
  addUser: <><circle cx="10" cy="8" r="3.2" /><path d="M3.5 20a6.5 6.5 0 0 1 13 0" /><path d="M19 8v6M16 11h6" /></>,
  dumbbell: <><path d="M4 10v4M7 9v6M17 9v6M20 10v4" /><path d="M7 12h10" /></>,
  gamepad: <><rect x="3" y="8" width="18" height="8" rx="4" /><path d="M8 12h4M10 10v4" /><circle cx="16" cy="11" r="1" /><circle cx="18" cy="13" r="1" /></>,
  smartphone: <><rect x="7" y="2.5" width="10" height="19" rx="2" /><path d="M11 5h2M10 18h4" /></>,
  shirt: <path d="M8 4 6 7l-3 2 2 4 2-1v8h10v-8l2 1 2-4-3-2-2-3H8z" />,
  utensils: <><path d="M6 3v8M9 3v8M6 7h3" /><path d="M15 3v18" /><path d="M18 3a3 3 0 0 0-3 3v3h3" /></>,

  flashlight: <><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9l-7-7z" /><polyline points="13 2 13 9 20 9" /></>,
  'flashlight-off': <line x1="1" y1="1" x2="23" y2="23" />,
...
export const Icon: React.FC<IconProps> = ({
  ...
  let pathContent: React.ReactElement | null = PATHS[name] || null;

  if (!pathContent) {
    if (!missingIconWarnings.has(name)) {
      missingIconWarnings.add(name);
      console.warn(`[Icon] Icon "${name}" not found. Fallback to "more".`);
    }
    pathContent = PATHS.more;
  }

  const computedStyle: React.CSSProperties = {
    ...style,
    animation: spin ? 'oc-icon-spin 1s linear infinite' : undefined,
